...
const Geography = React.forwardRef((props: GeographyProps, ref: any) => {
  const {
    geography,
    onMouseEnter,
    onMouseLeave,
  ...
  function handleMouseEnter(evt: React.MouseEvent<SVGPathElement, MouseEvent>) {
    setFocus(true);
    if (onMouseEnter) onMouseEnter(evt);
  }

  function handleMouseLeave(evt: React.MouseEvent<SVGPathElement, MouseEvent>) {
    setFocus(false);
  ...
  function handleMouseDown(evt: React.MouseEvent<SVGPathElement, MouseEvent>) {
    setPressed(true);
